					...
					<div className="row text_home">
        				<div className="col-sm-4 text-center">
        					...
        					<p className="text-center">
        						<a className="btn btn-default m40t" href="#/about" role="button">{t('viewDetails')} »</a>
        					</p>
        				</div>
        				<div className="col-sm-4 text-center">
        					...
        					<p className="text-center">
        						<a className="btn btn-default m40t" href="http://www.aifb.kit.edu/web/Critical_Information_Infrastructures/en" role="button" target="blank">{t('viewDetails')} »</a>
        					</p>
        				</div>
