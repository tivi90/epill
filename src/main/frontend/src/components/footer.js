                ...
                <div className="container">
                    <div className="row bottom-rule">
                        <div className="col-sm-4 footer-section">
                            <Link to="/">
                                <img src="/assets/images/logo_v.svg" className="logo" title="fratcher"
                                     alt="fratcher"></img>
                            </Link>
                        </div>
                        <div className="col-sm-5 footer-section">
                            <ul className="list-inline">
                                ...
                                <li><a href="http://www.aifb.kit.edu/web/Critical_Information_Infrastructures/en"
                                       target="blank">{t("team")}</a></li>
                                <li><a href="http://www.aifb.kit.edu/web/Anton_Grube/en"
                                       target="blank">{t("articles")}</a></li>
                    ...
                    <div className="row bottom-rule">
                        <div className="col-sm-12">
                            <nav className="navbar navbar-default navbar-footer">
                                <ul className="nav navbar-nav xs-center">
